...
user.get_book('J.K.Rowling', 'The Order of the Phoenix', 7, library)
user.get_book('J.K.Rowling', 'The Chamber of Secrets', 15, library)
print(library.books_available)
print(library.rented_books)
print(user.books)
print(user.get_book('J.K.Rowling', 'The Deathly Hallows', 10, library))
print(user2.get_book('J.K.Rowling', 'The Chamber of Secrets', 10, library))
