from encapsulation.project.product import Product
from encapsulation.project.food.soup import Soup
from encapsulation.project.beverage.beverage import Beverage
